                                ...
                                <tr>
                                    <td class="sm-px-24"
                                        ...
                                        <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0"
                                            ...
                                            <tr>
                                                <td style="color:white;mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #7367f0; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;"
