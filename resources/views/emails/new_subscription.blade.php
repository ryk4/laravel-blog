...
<div style="display: none;">Welcome onboard !</div>
                                ...
                                <tr>
                                    <td class="sm-px-24"
                                        ...
                                        <p style="margin: 24px 0;">
                                            You have subscribed to receive notifications on email
                                            <b>{{ $email }}</b> when new articles are released.
                                            We will aim to ensure high number of quality blogs are released as often as
                                            possible to keep you occupied 😎
                                        </p>
                                        <p style="font-weight: 500; font-size: 16px; margin-bottom: 0;">What other
                                            services do I provide?</p>
                                        <ul style="margin-bottom: 24px;">
                                            <li>
                                                Free help on small and specific errors in the area that I have
                                                competence. Will admit straight away if I lack the knowledge.
                                            </li>
                                            <li>
                                                One on one learning sessions on different topics. Group sessions are
                                                also available.
                                            </li>
                                            <li>
                                                Project assessment and evaluation in terms of the code quality,
                                                performance and so on. I can also help resolve issues if they
                                                fall in the area of my expertise.
                                            </li>
                                            <li>
                                                Anything else related to project development/maintenance.
                                            </li>
                                        </ul>
